...
const prayers = {
  ...
  departedPrayer: {
    ...
    text: [
      "Упокой, Господи, души усопших рабов Твоих: родителей моих, ближних и вся ближния рода моего, и други, и всех православных христиан, и прости им все их грехи, вольные и невольные, и даруй им Царствие Небесное.",
